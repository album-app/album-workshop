...
//new LeaderLine(document.getElementById('run_solution_from_catalog'), document.getElementById("solutions_in_the_cloud"), {color: color, startSocket: 'left', endSocket: 'left'});
